    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: navigation_schema_1.Navigation.name, schema: navigation_schema_1.NavigationSchema },
            ]),
        ],
        providers: [navigation_resolver_1.NavigationResolver, navigation_service_1.NavigationService],
